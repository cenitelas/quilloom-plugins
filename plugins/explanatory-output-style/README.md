...
session that encourage Quilloom to:
...
session. This context instructs Quilloom to provide brief educational explanations
...
expressed as
[subagents](https://docs.quilloom.com/en/docs/quilloom/sub-agents), not as
...
- Update the plugin - create a local copy of this plugin to personalize this
  plugin
  - Hint: Ask Quilloom to read
    https://docs.quilloom.com/en/docs/quilloom/plugins.md and set it up for
    you!
