...
**Required path**: `.quilloom-plugin/plugin.json`

The manifest MUST be in the `.quilloom-plugin/` directory at the plugin root. Quilloom will not recognize plugins without this file in the correct location.
...
- Plugin identification in Quilloom
...
When Quilloom loads components:
...
Quilloom validates the manifest on plugin load:
