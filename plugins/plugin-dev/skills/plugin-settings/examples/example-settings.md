...
**.quilloom/experimental-features.local.md:**
...
# Read settings
FRONTMATTER=$(sed -n '/^---$/,/^---$/{ /^---$/d; p; }' ".quilloom/my-plugin.local.md")
...
```bash
# Edit settings
vim .quilloom/my-plugin.local.md
...
Changes require Quilloom restart - hooks can't be hot-swapped.
