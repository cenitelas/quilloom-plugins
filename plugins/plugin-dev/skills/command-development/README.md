...
Comprehensive guidance on creating Quilloom slash commands, including file format, frontmatter options, dynamic arguments, and best practices.
...
Quilloom activates this skill when users:
...
Quilloom loads references and examples as needed based on task.
...
- **Project**: `.quilloom/commands/` (shared with team)
- **Personal**: `~/.quilloom/commands/` (your commands)
...
6. Test examples work with current Quilloom
