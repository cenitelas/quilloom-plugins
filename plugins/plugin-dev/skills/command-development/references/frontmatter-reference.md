...
**Purpose:** Specify which Quilloom model executes the command
...
- Quilloom can invoke programmatically
...
**Best practices:**
- Use sparingly (limits Quilloom's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid Quilloom model
```
