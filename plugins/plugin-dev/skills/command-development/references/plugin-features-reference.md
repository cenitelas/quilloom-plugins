...
This reference covers features and patterns specific to commands bundled in Quilloom plugins.
...
Quilloom automatically discovers commands in plugins using the following locations:
...
- Quilloom will automatically use Task tool to launch agent
...
- Mention skill by name to hint Quilloom should invoke it
