...
Use this template to generate agents using Quilloom with the agent creation system prompt.
...
Send this to Quilloom (with the agent-creation-system-prompt loaded):
...
### Step 3: Quilloom Returns JSON

Quilloom will return:
...
Tell Quilloom when the agent should activate:
...
- **Comprehensive**: Quilloom includes edge cases and quality checks
