...
assistant: "[How Quilloom should respond before triggering]"
<commentary>
[Explanation of why this agent should be triggered in this scenario]
</commentary>
assistant: "[How Quilloom triggers the agent - usually 'I'll use the [agent-name] agent...']"
</example>
```
...
**Purpose:** Show what Quilloom says before launching the agent
...
**Purpose:** Show how Quilloom invokes the agent
...
- Show Quilloom using Agent tool
