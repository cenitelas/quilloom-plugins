...
This is the exact system prompt used by Quilloom's agent generation feature, refined through extensive production use.
...
2. Feed to Quilloom with this system prompt
...
This provides AI-assisted agent generation following proven patterns from Quilloom's internal implementation.
