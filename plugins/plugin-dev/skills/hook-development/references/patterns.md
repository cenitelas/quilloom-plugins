...
This reference provides common, proven patterns for implementing Quilloom hooks. Use these patterns as starting points for typical hook use cases.
...
**Note:** Must restart Quilloom after creating/removing flag files for hooks to recognize changes.
...
```bash
#!/bin/bash
CONFIG_FILE="$CLAUDE_PROJECT_DIR/.quilloom/my-plugin.local.json"
...
**Configuration file (.quilloom/my-plugin.local.json):**
```json
{
  "strictMode": true,
  "maxFileSize": 500000,
