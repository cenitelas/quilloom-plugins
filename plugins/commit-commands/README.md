...
- Includes Quilloom attribution in commit message
...
This plugin is included in the Quilloom repository. The commands are automatically available when using Quilloom.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let Quilloom analyze your changes and match your repo's commit style
...
- Quilloom will analyze the full branch history for the PR description
...
- **Let Quilloom draft messages**: The commit message analysis learns from your repo's style
